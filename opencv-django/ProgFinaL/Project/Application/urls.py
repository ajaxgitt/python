...
urlpatterns = [
    ...
    path('homeInicio/<int:user_id>/',views.homeInicio, name='homeInicio'),
    ...
    path('Rfacial/', views.Rfacial, name='Rfacial'),
    path('Iniciomodel/',views.Iniciomodel, name='Iniciomodel'),
    path('RfacialModelo/',views.RfacialModelo, name='RfacialModelo')
]
